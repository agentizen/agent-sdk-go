...
const (
	...
	// the first agent to respond without error wins and the others are canceled.
...
type NetworkConfig struct {
	...
	// Orchestrator is the agent responsible for decomposing the prompt and synthesizing
